...
rank: 1
header:
  teaser: /assets/images/teaser-iceflow.jpg
  overlay_color: "#000"
  overlay_filter: 0.0
excerpt: >
    <video autoplay loop muted playsinline class="hero-video"><source src="/assets/images/banner-iceflow.mp4" type="video/mp4"></video>
...
<div class="entries-grid">
  {% assign sorted_pubs = site.publications | where_exp: "item", "item.categories contains 'iceflow'" | sort: 'date' | reverse %}
