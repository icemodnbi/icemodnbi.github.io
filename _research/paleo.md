---
title: "Paleo Ice Sheets"
rank: 2
header:
  teaser: /assets/images/teaser-paleo.jpg
  overlay_color: "#000"
excerpt: >
    <video autoplay loop muted playsinline class="hero-video"><source src="/assets/images/banner-paleo.mp4" type="video/mp4"></video>
...
<div class="entries-grid">
  {% assign sorted_pubs = site.publications | where_exp: "item", "item.categories contains 'paleo'" | sort: 'date' | reverse %}
