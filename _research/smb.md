...
rank: 4
header:
  teaser: /assets/images/teaser-smb.jpg
  overlay_image: /assets/images/banner-smb.jpg
  overlay_filter: 0.07
...
<div class="entries-grid">
  {% assign sorted_pubs = site.publications | where_exp: "item", "item.categories contains 'smb'" | sort: 'date' | reverse %}
